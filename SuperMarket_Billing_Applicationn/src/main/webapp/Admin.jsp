    ...
    <body>
            ...
            <div class="main" id="newMain">
                <div class="navigation">
                    <nav class="navbartop">
                        ...
                        <a href="AddInventory.jsp"><i class="fa fa-plus"></i>Add Items</a>
                        <a href=deleteProduct.jsp><i class="fa fa-trash" aria-hidden="true"> Remove</i></a>
        ...
        <div>
            <div id="sidenav" class="sidebar">
                ...
                <a href="Home.jsp"><i class="fa fa-home"></i> Go to Home</a>
                <a href="Login.jsp"><i class="fa fa-address-card-o"></i> Login</a>
                <a href="Register_new.jsp"><i class="fa fa-address-card-o"></i> New Register</a>
            </div>
        </div>
